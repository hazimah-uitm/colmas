...
class YearlyReportController extends Controller
{
    ...
    {
        $data = $this->exportData($request); // No need to call ->get() if it returns data directly
        ...
        [
            ...
            'labManagementList' => $data['labManagementList'], // Pass required data from exportData
            'computerLabList' => $data['computerLabList'], // Pass required data from exportData
            'campusList' => $data['campusList'], // Pass required data from exportData
        ]);
    }    
