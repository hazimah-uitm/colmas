            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        ...
                        <h4 class="text-secondary my-1">{{ $totalUnmaintainedLabs > 0 ? $totalUnmaintainedLabs : 0 }}</h4>
                    </div>
        ...
        <div class="mb-4 bg-white p-4 border rounded">
            <form action="{{ isset($announcement) ? route('home.update', $announcement->id) : route('home.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" value="{{ $announcement->title ?? old('title') }}" required>
                </div>
                <div class="mb-3">
