                    ...
                    <tbody>
                        @if (count($announcementList) > 0)
                            @foreach ($announcementList as $announcement)
                                <tr>
                                    <td class="text-center">{{ ($announcementList->currentPage() - 1) * $announcementList->perPage() + $loop->iteration }}
                                    </td>
            ...
            <div class="mt-3 d-flex justify-content-between">
                ...
                <div class="mt-3 d-flex justify-content-end">
                    <span class="mx-2 mt-2 small text-muted">
                        Menunjukkan {{ $announcementList->firstItem() }} hingga {{ $announcementList->lastItem() }}
                        daripada
