            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Senarai Makluman</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="col-12 col-md-3 d-flex justify-content-center justify-content-md-end mt-2 mt-md-0">
            <a href="{{ route('announcement.trash') }}">
...
<!--end breadcrumb-->
<h6 class="mb-0 text-uppercase">Senarai Makluman</h6>
<hr />
<div class="card">
    <div class="card-body">
        <div class="d-lg-flex align-items-center mb-4 gap-3">
            <div class="position-relative">
                <form action="{{ route('announcement.search') }}" method="GET" id="searchForm"
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ ($announcementList->currentPage() - 1) * $announcementList->perPage() + $loop->iteration }}
                        </td>
                        ...
                        <td>
                            <a href="{{ route('announcement.edit', $announcement->id) }}" class="btn btn-info btn-sm"
                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Kemaskini">
                                <i class="bx bxs-edit"></i>
                            </a>
                            <a href="{{ route('announcement.show', $announcement->id) }}" class="btn btn-primary btn-sm"
        ...
        <div class="mt-3 d-flex justify-content-between">
            <div class="d-flex align-items-center">
                ...
                <form action="{{ route('announcement.search') }}" method="GET" id="perPageForm"
            ...
            <div class="mt-3 d-flex justify-content-end">
                <span class="mx-2 mt-2 small text-muted">
                    Menunjukkan {{ $announcementList->firstItem() }} hingga {{ $announcementList->lastItem() }} daripada
                    {{ $announcementList->total() }} rekod
                </span>
                <div class="pagination-wrapper">
                    {{ $announcementList->appends([
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @isset($announcement)
                Adakah anda pasti ingin memadam rekod <span style="font-weight: 600;">Makluman
                    {{ $announcement->title }}</span>?
                @else
                Error: announcement data not available.
                @endisset
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                @isset($announcement)
                <form class="d-inline" method="POST" action="{{ route('announcement.destroy', $announcement->id) }}">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
