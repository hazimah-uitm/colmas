    ...
    <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if (!empty($trash->work_checklist_id))
                        ...
                        <td>{!! nl2br(e($trash->remarks ?? '-')) !!}</td>
                        <td>
                            <a href="{{ route('lab-management.maintenance-records.restore', ['labManagement' => $labManagement->id, 'id' => $trash->id]) }}" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Kembalikan">
                                <i class="bx bx-undo"></i>
                            </a>
                            <a type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Padam">
                                <span class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $trash->id }}"><i class="bx bx-trash"></i></span>
                            </a>
                        </td>
                        </td>
                    </tr>
        ...
        <div class="mt-3 d-flex justify-content-between">
            <div class="d-flex align-items-center">
                ...
                <form action="{{ route('lab-management.maintenance-records', ['labManagement' => $labManagement->id]) }}" method="GET" id="perPageForm">
...
@foreach ($trashList as $trash)
<div class="modal fade" id="deleteModal{{ $trash->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
