                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Senarai Rekod PC Diselenggara/Rosak
                                Dipadam</li>
                        </ol>
                    </nav>
                </div>
                            ...
                            @foreach ($trashList as $trash)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('lab-management.maintenance-records.restore', ['labManagement' => $labManagement->id, 'id' => $trash->id]) }}"
                    ...
                    <div class="modal-footer">
                        ...
                        @isset($trash)
                            <form class="d-inline" method="POST"
                                action="{{ route('lab-management.maintenance-records.forceDelete', ['labManagement' => $labManagement->id, 'id' => $trash->id]) }}">
                                {{ method_field('delete') }}
                                {{ csrf_field() }}
