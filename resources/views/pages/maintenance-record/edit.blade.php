    ...
    <div class="card-body">
        <form method="POST" action="{{ $save_route }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('lab_management_id') is-invalid @enderror"
            ...
            <div class="mb-3" id="computerNameContainer">
                ...
                <input type="hidden" name="hidden_computer_name_automatik" id="hidden_computer_name_automatik" value="{{ $computerNameAuto }}">
            </div>
            ...
            <div class="mb-3" id="ipAddressContainer">
                ...
                <input type="hidden" name="hidden_ip_address_automatik" id="hidden_ip_address_automatik" value="{{ $ipAddressAuto }}">
            </div>
            ...
            <div class="mb-3" id="workChecklistContainer">
                ...
                @foreach ($workChecklists as $workChecklist)
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="work_checklist_{{ $workChecklist->id }}"
            ...
            <div class="mb-3" id="vmsNoContainer">
                ...
                <input type="text" class="form-control @error('vms_no') is-invalid @enderror" id="vms_no"
            ...
            <div class="mb-3" id="aduanUnitNoContainer">
                ...
                <input type="text" class="form-control @error('aduan_unit_no') is-invalid @enderror"
