                            ...
                            @foreach ($maintenanceRecordList as $maintenanceRecord)
                                <tr>
                                    <td class="text-center">
                                        {{ ($maintenanceRecordList->currentPage() - 1) * $maintenanceRecordList->perPage() + $loop->iteration }}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($maintenanceRecord->entry_option == 'pc_keluar')
                                            <p>PC dibawa keluar pada {{ $maintenanceRecord->keluar_date }} <br> ke
                                                {{ $maintenanceRecord->keluar_location }}</p>
                                        @else
