    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="position-relative me-2">
                <form action="{{ route('lab-management.maintenance-records.search', ['labManagement' => $labManagement->id]) }}" method="GET" id="searchForm"
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ ($maintenanceRecordList->currentPage() - 1) * $maintenanceRecordList->perPage() + $loop->iteration }}
                        </td>
            ...
            <div class="mt-3 d-flex justify-content-between">
                ...
                <div class="mt-3 d-flex justify-content-end">
                    <span class="mx-2 mt-2 small text-muted">
                        Menunjukkan {{ $maintenanceRecordList->firstItem() }} hingga {{ $maintenanceRecordList->lastItem() }} daripada
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('resetButton').addEventListener('click', function() {
                ...
                window.location.href = "{{ route('lab-management.maintenance-records', ['labManagement' => $labManagement->id]) }}";
            });
        });
    </script>
    <!--end page wrapper -->
