                    ...
                    <form action="{{ route('report') }}" method="GET" id="searchForm"
                        ...
                        <div class="input-group">
                            ...
                            @hasanyrole('Pegawai Penyemak|Superadmin')
                                <select name="category" class="form-select form-select-sm ms-2 rounded" id="categoryFilter">
                                    <option value="">Semua Kategori</option>
                                    <option value="makmal_komputer"
                                        {{ Request::get('category') == 'makmal_komputer' ? 'selected' : '' }}>
                                        Makmal Komputer
                                    </option>
                                    <option value="sudut_it" {{ Request::get('category') == 'sudut_it' ? 'selected' : '' }}>
                                        Sudut IT
                                    </option>
                                    <option value="pusat_data" {{ Request::get('category') == 'pusat_data' ? 'selected' : '' }}>
                                        Pusat Data
                                    </option>
                                </select>
                            ...
                            @foreach ($labManagementList as $labManagement)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ str_replace('_', ' ', ucwords(strtolower($labManagement->status))) }}</td>
                                    <td class="text-center">
