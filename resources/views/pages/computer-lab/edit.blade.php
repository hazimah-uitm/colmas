            ...
            <form method="POST" action="{{ $save_route }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}"
                        id="username" name="username" value="{{ old('username') ?? $computerLab->username }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}"
                        id="password" name="password" value="{{ old('password') ?? $computerLab->password }}">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select {{ $errors->has('software_id') ? 'is-invalid' : '' }}" name="software_id[]"
                        ...
                        @foreach ($softwareList as $software)
                            <option value="{{ $software->id }}" @if (in_array($software->id, old('software_id', $computerLab->software_id ?? []))) selected @endif>
                                {{ $software->title }}
                            </option>
                        @endforeach
                    </select>
