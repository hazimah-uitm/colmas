            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @hasanyrole('Superadmin|Admin')
                            <a href="{{ route('lab-checklist.edit', $labChecklist->id) }}" class="btn btn-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Kemaskini">
                                <i class="bx bxs-edit"></i>
                            </a>
                            <a href="{{ route('lab-checklist.show', $labChecklist->id) }}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Papar">
                                <i class="bx bx-show"></i>
                            </a>
                            <a type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Padam">
                                <span class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $labChecklist->id }}"><i class="bx bx-trash"></i></span>
                            </a>
                            @endhasanyrole
                        </td>
                    </tr>
        ...
        <div class="mt-3 d-flex justify-content-between">
            ...
            <div class="mt-3 d-flex justify-content-end">
                <span class="mx-2 mt-2 small text-muted">
                    Menunjukkan {{ $labChecklistList->firstItem() }} hingga {{ $labChecklistList->lastItem() }} daripada
...
@foreach ($labChecklistList as $labChecklist)
<div class="modal fade" id="deleteModal{{ $labChecklist->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                @isset($labChecklist)
                <form class="d-inline" method="POST" action="{{ route('lab-checklist.destroy', $labChecklist->id) }}">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
