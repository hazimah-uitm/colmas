            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @hasanyrole('Superadmin|Admin')
                        <td>
                            <a href="{{ route('software.edit', $software->id) }}" class="btn btn-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Kemaskini">
                                <i class="bx bxs-edit"></i>
                            </a>
                            <a href="{{ route('software.show', $software->id) }}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Papar">
                                <i class="bx bx-show"></i>
                            </a>
                            <a type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Padam">
                                <span class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $software->id }}"><i class="bx bx-trash"></i></span>
                            </a>
                        </td>
                        @endhasanyrole
                    </tr>
...
@foreach ($softwareList as $software)
<div class="modal fade" id="deleteModal{{ $software->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
